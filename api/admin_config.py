...
SECTIONS: tuple[ConfigSectionSpec, ...] = (
    ...
    ConfigSectionSpec(
        "models",
        "Model Routing",
        "Default provider/model route used for all Codex Responses.",
    ),
    ConfigSectionSpec(
        "thinking",
        "Thinking",
...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        description="Default provider/model route for all Codex Responses requests.",
    ),
    ConfigFieldSpec(
