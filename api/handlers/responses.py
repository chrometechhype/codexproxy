    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "CodexProxy /v1/responses supports streaming only; omit stream or set stream=true."
            )
