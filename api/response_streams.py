...
from core.anthropic import anthropic_error_type_for_failure
...
from core.failures import find_execution_failure
from core.trace import close_stream_input, trace_event
...
def _trace_response_cleanup_failure(operation: str, exc: BaseException) -> None:
    trace_event(
        stage="egress",
        event="api.response.cleanup_failed",
        source="api",
        operation=operation,
