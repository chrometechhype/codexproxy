"""Platform-neutral lifecycle for the CodexProxy desktop shell."""
...
class DesktopController:
    """Coordinate one tray loop with one in-process CodexProxy server owner."""
    ...
    def run(self) -> None:
        """Run the tray on this thread and the CodexProxy server on its owned worker."""
...
def launch_desktop(tray_factory: DesktopTrayFactory) -> None:
    """Start the singleton desktop host or focus the already running CodexProxy UI."""
