"""Direct HTTP and child-environment policy for cdx-local traffic."""
...
def open_local_request(request: Request, *, timeout: float) -> Any:
    """Open an cdx-local request without consulting machine proxy settings."""
...
def with_local_proxy_bypass(
    ...
    *,
    ...
    """Copy an environment and keep its cdx-local destination off proxies."""
