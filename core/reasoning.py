...
class ReasoningEffort(StrEnum):
    """Named reasoning effort understood at the CodexProxy application boundary."""
    ...
    def budget_tokens(self) -> int:
        """Return CodexProxy's numeric token budget for this effort."""
...
class ReasoningPolicy:
    ...
    def numeric_budget_tokens(self) -> int | None:
        """Express this intent as an exact or cdx-mapped numeric budget."""
