...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "process env, user env file, repo env file, CODEX_PROXY_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        (
            "test_CODEX_PROXY_server_entrypoint_starts_server",
    ...
    CapabilityContract(
        ...
        "drop_in_codex_replacement",
        "cli.launchers.codex",
        "Codex CLI binary and codexproxy provider env",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "cli.launchers.pi",
        "Pi CLI binary, bundled extension, and CodexProxy child-process environment",
