...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "codexproxy.api.handlers.messages.MessagesHandler",
    ...
    CapabilityContract(
        ...
        "codexproxy.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "codexproxy.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "codexproxy.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "codexproxy.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "codexproxy.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "codexproxy.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "codexproxy.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "codexproxy.core.anthropic.tools",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "codexproxy.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "codexproxy.api.optimization_handlers",
    ...
    CapabilityContract(
        ...
        "codexproxy.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "codexproxy.config.loader.get_settings",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "codexproxy.config.env_migrations.consolidate_managed_config",
        "retired ENABLE_MODEL_THINKING or tier override in an CDX-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "codexproxy.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "codexproxy.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "codexproxy.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "codexproxy.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "codexproxy.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "codexproxy.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "codexproxy.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "codexproxy.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "codexproxy.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "codex_cli_drop_in",
        "drop_in_codex_replacement",
        "codexproxy.cli.launchers.codex",
        "Codex CLI binary and cdx provider env",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "codexproxy.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and CDX child-process environment",
        "Anthropic Messages provider with an CDX-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "opencode_cli_integration",
        "codexproxy.cli.launchers.opencode",
        "OpenCode V1 binary, live CDX model catalog, and child-process config",
        "Responses provider scoped to CDX with bearer authentication",
    ...
    CapabilityContract(
        ...
        "codexproxy.providers.runtime and codexproxy.messaging.platforms.factory",
