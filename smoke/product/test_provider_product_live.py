...
def _scenario_tool_result_continuation(
    ...
    first_payload = {
        ...
        "max_tokens": 256,
        "messages": [
            {"role": "user", "content": "Use echo_smoke once with value CDX_TOOL."}
        ],
        "tools": [echo_tool_schema()],
