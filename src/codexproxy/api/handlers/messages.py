...
from codexproxy.api.detection import is_safety_classifier_request
from codexproxy.api.optimization_handlers import try_optimizations
from codexproxy.api.request_errors import (
    http_status_for_unexpected_api_exception,
    log_unexpected_api_exception,
    require_non_empty_messages,
    unexpected_http_exception,
)
from codexproxy.api.request_ids import new_request_id
...
from codexproxy.api.web_tools.request import (
    is_web_server_tool_request,
    unsupported_server_tool_error,
)
from codexproxy.api.web_tools.streaming import stream_web_server_tool_response
from codexproxy.application.errors import ApplicationError, InvalidRequestError
from codexproxy.application.execution import ProviderExecutor, TokenCounter
from codexproxy.application.ports import ProviderResolver
from codexproxy.application.routing import ModelRouter, RoutedMessagesRequest
...
from codexproxy.core.diagnostics import safe_exception_message
from codexproxy.core.failures import ExecutionFailure, find_execution_failure
from codexproxy.core.reasoning import ReasoningControl, ReasoningPolicy
from codexproxy.core.trace import trace_event
...
class MessagesHandler:
    ...
    def _intercept_web_server_tool(
        ...
        trace_event(
            stage="routing",
            event="codexproxy.api.optimization.web_server_tool",
            source="api",
            model=routed.resolved.original_model,
        )
    ...
    def _intercept_local_optimization(
        ...
        trace_event(
            stage="routing",
            event="codexproxy.api.optimization.short_circuit",
            source="api",
            model=routed.resolved.original_model,
        )
