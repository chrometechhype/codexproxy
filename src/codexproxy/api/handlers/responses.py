...
from codexproxy.application.execution import ProviderExecutor
...
from codexproxy.core.anthropic import MessagesRequest
    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "CDX /v1/responses supports streaming only; omit stream or set stream=true."
            )
