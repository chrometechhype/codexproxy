...
from codexproxy.application.errors import ApplicationError
from codexproxy.application.execution import TokenCounter
    ...
    def count(
        ...
        with logger.contextualize(request_id=request_id):
            try:
                ...
                trace_event(
                    stage="routing",
                    event="codexproxy.api.route.resolved",
                    source="api",
                ...
                trace_event(
                    stage="ingress",
                    event="codexproxy.api.count_tokens.completed",
                    source="api",
                    request_id=request_id,
