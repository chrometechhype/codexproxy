...
from codexproxy.application.ports import ProviderResolver, RequestRuntimeLease
...
async def list_models(
    ...
    trace_event(stage="ingress", event="codexproxy.api.models.list", source="api")
...
async def stop_cli(
    ...
    trace_event(
        stage="ingress",
        event="codexproxy.api.cli.stop_via_messaging_workflow",
        source="api",
