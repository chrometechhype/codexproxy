"""Build Codex model catalogs from the CDX model-list route."""
...
def build_codex_model_catalog(models_response: Mapping[str, JsonValue]) -> JsonObject:
    """Convert CDX `/v1/models` data into Codex `model_catalog_json` payload."""
...
def _codex_catalog_entry(candidate: ClientModel, *, priority: int) -> JsonObject:
    return {
        ...
        "description": "CodexProxy provider model",
