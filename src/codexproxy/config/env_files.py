...
CODEX_PROXY_ENV_FILE_ENV = "CODEX_PROXY_ENV_FILE"
CODEX_PROXY_CONFIG_SCHEMA_ENV = "CODEX_PROXY_CONFIG_SCHEMA"
...
def legacy_explicit_env_path(
    ...
    value = source.get(CODEX_PROXY_ENV_FILE_ENV, "").strip()
...
def verified_checkout_env_path() -> Path | None:
    ...
    package = checkout / "src" / "codexproxy"
    ...
    try:
        ...
        return None
    if 'name = "codexproxy"' not in project_text:
        return None
