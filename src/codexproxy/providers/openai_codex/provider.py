...
from codexproxy.core.anthropic.openai_tool_names import OpenAIToolNameCodec
...
from codexproxy.providers.base import BaseProvider, ProviderConfig
from codexproxy.providers.failure_policy import (
    RetryableProviderProtocolError,
    classify_provider_failure,
)
from codexproxy.providers.stream_recovery import RecoveryController

from .auth import OpenAIAccess, OpenAIAuthManager, OpenAIReconnectRequired
from .login import OPENAI_CODEX_ORIGINATOR

try:
    CODEX_PROXY_VERSION = version("codexproxy")
except PackageNotFoundError:
    CODEX_PROXY_VERSION = "dev"
    ...
    def __init__(
        ...
        *,
        ...
        self._client_headers = {
            "User-Agent": f"{OPENAI_CODEX_ORIGINATOR}/{CODEX_PROXY_VERSION}",
    ...
    async def list_model_infos(self) -> frozenset[ProviderModelInfo]:
        ...
        async def fetch() -> Any:
            ...
            response = await self._client.get(
                "models",
                params={"client_version": CODEX_PROXY_VERSION},
