...
from codexproxy.application.routing import ResolvedModel, RoutedMessagesRequest
...
async def test_progress_timeout_before_first_chunk_is_canonical_and_correlated() -> (
    ...
    with patch("codexproxy.application.execution.trace_event") as trace_mock:
    ...
    timeout_traces = [
        ...
        if call.kwargs.get("event") == "codexproxy.provider.progress_timeout"
    ]
